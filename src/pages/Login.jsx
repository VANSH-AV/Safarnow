    ...
    <div>
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white text-muted">your Safarnow account</span>
        </div>
      </div>
      <SignIn
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <Lock className="absolute left-3.5 inset-y-0 my-auto w-4 h-4 text-muted pointer-events-none" />
            <input
              type={showPassword ? 'text' : 'password'}
              value={password}
              onChange={(e) => setPassword(e.target.value)}
              placeholder="Enter your password"
              className="w-full pl-10 pr-12 py-3 bg-light border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue/30 focus:border-blue transition-all"
            />
            <button
              type="button"
        ...
        <div className="flex items-center justify-end">
          <button type="button" className="text-sm text-blue hover:underline font-medium">
            Forgot Password?
          </button>
        </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 py-3.5 rounded-xl font-semibold text-dark hover:bg-gray-50 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
      >
        {googleLoading ? (
      ...
      <p className="text-center text-xs text-muted/60 mt-4">
        Demo: demo@safarnow.com / demo123
      </p>
    </>
  );
}
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-navy via-navy to-blue overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <p className="text-lg text-white/70 leading-relaxed max-w-md">
            Join thousands of travelers using AI-powered insights to plan safer, more memorable trips across India and beyond.
          </p>
          <div className="flex items-center gap-4 mt-10">
            <div className="text-center">
              <p className="text-2xl font-bold text-white">500+</p>
              <p className="text-sm text-white/50">Destinations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-white/50">App Rating</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          {mode === 'clerk' ? (
            ...
            <LocalLogin onGoogle={signInWithGoogle} />
          )}
